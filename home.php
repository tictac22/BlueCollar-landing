<? get_header()  ?>
<div class="wrapper">
	<div id="home" class="opening">
		<div class="container">
			<div class="opening__inner">
				<p class="opening__text">Opening Hours: 06:00 to 20:00</p>
				<div class="opening__socials">
					<a href="#" aria-label="facebook" class="opening__social">
						<svg
							width="19"
							height="18"
							viewBox="0 0 19 18"
					...
					<a href="#" aria-label="twiter" class="opening__social">
						<svg
							width="20"
							height="17"
							viewBox="0 0 20 17"
					...
					<a href="#" aria-label="pinterest" class="opening__social">
						<svg
							width="19"
							height="19"
							viewBox="0 0 19 19"
					...
					<a href="#" aria-label="instagram" class="opening__social">
						<svg
							width="18"
							height="19"
							viewBox="0 0 18 19"
			...
			<div class="container">
				<div class="welcome__inner">
					<div class="welcome__img">
						<picture
							><source src="<?= ASSETS_IMG ?>welcome.webp" type="image/webp" />
							<img loading="lazy" src="<?= ASSETS_IMG ?>welcome.jpg" alt="worker"
						/></picture>
					</div>
					<div class="welcome__about">
						<div class="welcome__greetings welcome-greetings">
							...
							/>
							<h3 class="welcome-greetings__text">Welcome BlueColla</h3>
						</div>
						<div class="welcome__title">We Provide Your Future</div>
						<div class="welcome__paragraph">
							Bluecollar Electrical services was established in 2008. We are trusted and reliable
							electricians who serve customers in the city as well as throughout United States Of
							America.
						</div>
						<div class="welcome__paragraph">
							We have extensive experience of domestic and business electrical installations and
							no job is too small. Our customers value our professionalism, work ethic and our
							competitive prices.
						</div>
						...
						<div class="welcome__statistics welcome-statistics">
							<div class="welcome-statistics__container">
								...
								<ul class="welcome-statistics__list">
			...
			<div class="container">
				<div class="offer__info">
					<div class="offer__subtitle offer-subtitle">
						...
						/>
						<h4 class="offer-subtitle__text">What We Offer</h4>
					</div>
					<h3 class="offer__title">Professional Main Services</h3>
					<p class="offer__text">
						We have extensive experience of domestic and business electrical installations and no
						job is too small. Our customers value our professionalism, work ethic and our
						competitive prices.
					</p>
				</div>
						...
						<div class="commercal__decsr">
							<div class="commercal-subtitle">
								<img
									...
									alt="commerical"
								/>
								<h4 class="commercal-subtitle__text">Electrical installation</h4>
							</div>
							<h3 class="commercal__title">Commercial</h3>
							<p class="commercal__text">
								Electrical & Maintenance Services Ltd offers a full range of electrical services
								to suit your needs – from moving a light switch to complete house rewires.
							</p>
							<p class="commercal__text">
								In addition to providing fully qualified, competent electricians in and around
								London, the company also runs an electrical wholesale shop.
							</p>
							<button class="commercal__button button">Read More</button>
						</div>
						<div class="commercal__img">
							<picture
								><source src="<?= ASSETS_IMG ?>commercal.webp" type="image/webp" />
								<img loading="lazy" src="<?= ASSETS_IMG ?>commercal.jpg" alt="commercial"
							/></picture>
						</div>
					</div>
				</div>
